...
<body>
	...
	<div id="form">
			<table border="1px" width="995px" align="center" cellpadding="0px"
				cellspacing="0px">
				<tr height="50px">
					<td colspan="2" align="center">修改资讯</td>&nbsp;&nbsp;
				...
				<tr height="50px">
					...
					<td><input type="text" name="title" id="title" value="${newsList[0].title }"/></td>

				</tr>
				<tr height="200px">
					<td align="center">资讯内容</td>
					<!--文本框 -->
					<td><textarea rows="50" cols="50" name="content" id="content">${newsList[0].title }</textarea>
				...
				<tr height="50px">
					...
					<td>&nbsp;&nbsp;&nbsp;<input type="submit" value="确认"
						onclick="return save(${newsList[0].id});">&nbsp;&nbsp;&nbsp; <a
